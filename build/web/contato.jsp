<%-- 
    Document   : contato
    Created on : 21 de set de 2020, 19:42:51
    Author     : Bruno
--%>
...
<%
    ...
    if(ContactList == null){
        ...
        ContactList.add(new Contato("admin", "admin@domain.com", "+55 (12) 96870321"));
        ContactList.add(new Contato("Fulano", "fulano@domain.com", "+55 (11) 945878873"));
        ContactList.add(new Contato("Beltrano", "beltrano@domain.com", "+55 (13) 9308716"));
        ContactList.add(new Contato("Cicrano", "cicrano@domain.com", "+55 (13) 94105768"));
